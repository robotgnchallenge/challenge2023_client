...
####################################################################
graspnet_root = f'{os.path.expanduser('~')}/dataset/graspnet' # ROOT PATH FOR GRASPNET
dump_folder = f'{os.path.expanduser('~')}/code/graspnet-baseline/logs/dump_rs' # ROOT PATH FOR DUMP
####################################################################
